...
#' @param fqd character: the fully path of fastq files.
...
#' @examples ## output filterd and compressed fastq files ##
#' # fqd <- system.file("extdata/E-MTAB-1147", package = "ShortRead")
#' # sffx <- ".fastq.gz"
#' # outd <- "~/pub/sampledata/rnaseq/project1/qcfq"
#' # unlink(outd, recursive = T)
#' # fqfilter(fqd=fqd, outd=outd, droplen = 20)
#' @importFrom ShortRead FastqStreamer yield nFilter narrow trimTailw width writeFastq
#' @export
# nhead = NULL; ntail = NULL; droplen = NULL
